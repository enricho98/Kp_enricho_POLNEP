    ...
    <div class="row g-3 align-items-center mt-2">
      <div class="col-auto">
       <a href="javascript:void(0)" class="btn btn-primary" id="create-new-post" onclick="addPost()">Tambah Data <i class="fa fa-plus"></i></a>
        <a href="/import-form" class="btn btn-success" id="import-new-post">Import Data <i class="fa fa-upload"></i></a>
        <a href="/exportformat" class="btn btn-success ">Format Import <i class="fa fa-download"></i></a>
        <a href="/download" class="btn btn-danger " style="float: right;margin-left:5px;">Manual Book <i class="fa fa-book"></i></a>
        <a href="/exportexcel" class="btn btn-warning" style="float: right;">Export Data <i class="fa fa-database"></i></a>
        ...
        <table id="laravel_crud" class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr id="row_<?php echo e($post->id); ?>">
              ...
              <td><?php echo e($post->prodi); ?></td>
              <td><?php echo e($post->message); ?></td>
              <td><?php echo e($post->pekerjaan); ?></td>
              <td><?php echo e($post->telepon); ?></td>

              <td>
                <div class="container1">
                  <a href="javascript:void(0)" data-id="<?php echo e($post->id); ?>" onclick="editPost(event.target)" class="btn btn-success">Edit <i class="fa fa-edit text-gray-300"></i></a>
                  <a href="javascript:void(0)" data-id="<?php echo e($post->id); ?>" data-nama="<?php echo e($post->name); ?>" class="btn btn-danger delete">Hapus <i class="fa fa-trash"></i></a>
                </div>
              </td>
            </tr>
...
<?php endif; ?><?php /**PATH /home/testimon/testimoni-polnep/resources/views/posts.blade.php ENDPATH**/ ?>