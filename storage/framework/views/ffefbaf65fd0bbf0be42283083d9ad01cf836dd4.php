      ...
      <div class="col-12">
        ...
        <table id="laravel_crud" class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            $no=1;
            ?>
            <?php $__currentLoopData = $sadmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?><?php /**PATH /home/testimon/testimoni-polnep/resources/views/sadmin.blade.php ENDPATH**/ ?>